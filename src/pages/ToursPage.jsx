    ...
    const fetchTours = async () => {
      ...
      try {
        const response = await axios.get(
          `https://api.sandbox.viator.com/partner/v1/products/search?topX=10&sortOrder=RELEVANCE&categoryId=${categoryId}&currencyCode=USD&country=US`,
          {
            headers: {
        ...
        // Some sandbox responses return results in `products`, not `data`
        const tourList = response.data?.data || response.data?.products || [];
